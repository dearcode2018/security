package com.techrare.het.base.action;
/*
...
public class GuidAction {
	     ...
	     */
	    public GuidAction(boolean secure) {
	    ...
	    public static String newGuid(){
	    	GuidAction rdmGUID = new GuidAction();
	    ...
	    public static void main(String args[]) {
	        ...
	        System.out.println(GuidAction.newGuid());
	    }
	}
